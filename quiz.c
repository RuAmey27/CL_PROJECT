...
void main()
{
	...
	Display();
	scanf("%s",name);
	printf("Entre the registration number : ");
	scanf("%s",reg);
	...
	{
		printf("\n\n\n\n\n\n");
		printf("                     THE C MOCK TEST                    ");
		printf("\n\n\n\n\n\n\t\t\t    PRESS ENTRE TO START THE EXAM     ");
		printf("\n\n\n\t\t\t\t   RULES OF THE EXAM   :     \n");
		...
		system("pause");
		system("cls");
		printf("\nRegister by Entring the Name of the student for appering the test :\n");				
	}